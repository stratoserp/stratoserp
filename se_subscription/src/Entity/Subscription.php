 ...
 *   },
 *   links = {
 *     "canonical" = "/se/admin/se_subscription/{se_subscription}",
 *     "add-page" = "/se/admin/se_subscription/add",
 *     "add-form" = "/se/admin/se_subscription/add/{se_subscription_type}",
 *     "edit-form" = "/se/admin/se_subscription/{se_subscription}/edit",
 *     "delete-form" = "/se/admin/se_subscription/{se_subscription}/delete",
 *     "version-history" = "/se/admin/se_subscription/{se_subscription}/revisions",
 *     "revision" = "/se/admin/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/view",
 *     "revision_revert" = "/se/admin/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/revert",
 *     "revision_delete" = "/se/admin/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/delete",
 *     "translation_revert" = "/se/admin/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/revert/{langcode}",
 *     "collection" = "/se/admin/se_subscription",
 *   },
