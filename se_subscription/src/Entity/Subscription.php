 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/se_subscription/{se_subscription}",
 *     "add-page" = "/admin/structure/se_subscription/add",
 *     "add-form" = "/admin/structure/se_subscription/add/{se_subscription_type}",
 *     "edit-form" = "/admin/structure/se_subscription/{se_subscription}/edit",
 *     "delete-form" = "/admin/structure/se_subscription/{se_subscription}/delete",
 *     "version-history" = "/admin/structure/se_subscription/{se_subscription}/revisions",
 *     "revision" = "/admin/structure/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/view",
 *     "revision_revert" = "/admin/structure/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/revert",
 *     "revision_delete" = "/admin/structure/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/delete",
 *     "translation_revert" = "/admin/structure/se_subscription/{se_subscription}/revisions/{se_subscription_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/se_subscription",
 *   },
...
class Subscription extends RevisionableContentEntityBase implements SubscriptionInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the se_subscription owner the
    // revision author.
