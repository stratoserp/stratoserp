 ...
 *
 * @FieldWidget(
 *   id = "webform_integration_entity_reference_autocomplete",
 *   label = @Translation("Webform integration autocomplete"),
 ...
 * )
 */
class WebformIntegrationEntityReferenceAutocompleteWidget extends EntityReferenceAutocompleteWidget {

  use WebformIntegrationEntityReferenceWidgetTrait;
