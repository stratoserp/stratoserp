 ...
 *
 * @FieldWidget(
 *   id = "webform_integration_entity_reference_select",
 *   label = @Translation("Webform integration select list"),
 ...
 */
class WebformIntegrationEntityReferenceSelectWidget extends OptionsWidgetBase {
