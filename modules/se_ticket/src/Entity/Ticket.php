 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/se/ticket/se_ticket/{se_ticket}",
 *     "add-form" = "/admin/se/ticket/se_ticket/add",
 *     "edit-form" = "/admin/se/ticket/se_ticket/{se_ticket}/edit",
 *     "delete-form" = "/admin/se/ticket/se_ticket/{se_ticket}/delete",
 *     "version-history" = "/admin/se/ticket/se_ticket/{se_ticket}/revisions",
 *     "revision" = "/admin/se/ticket/se_ticket/{se_ticket}/revisions/{se_ticket_revision}/view",
 *     "revision_revert" = "/admin/se/ticket/se_ticket/{se_ticket}/revisions/{se_ticket_revision}/revert",
 *     "revision_delete" = "/admin/se/ticket/se_ticket/{se_ticket}/revisions/{se_ticket_revision}/delete",
 *     "translation_revert" = "/admin/se/ticket/se_ticket/{se_ticket}/revisions/{se_ticket_revision}/revert/{langcode}",
 *     "collection" = "/admin/se/ticket/se_ticket",
 *   },
...
class Ticket extends RevisionableContentEntityBase implements TicketInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // make the se_ticket owner the revision author.
