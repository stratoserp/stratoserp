...
class TicketRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'se_ticket_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()
      ->addMessage(t('Ticket %title has been reverted to the revision from %revision-date.', [
        '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\se_ticket\Entity\TicketInterface $revision
