...
/**
 * Provides a form for reverting a Quote revision.
 *
 * @ingroup se_quote
 */
class QuoteRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'se_quote_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Quote: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    $this->messenger()
      ->addMessage(t('Quote %title has been reverted to the revision from %revision-date.', [
        '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\se_quote\Entity\QuoteInterface $revision
