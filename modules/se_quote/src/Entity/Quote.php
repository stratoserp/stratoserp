 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/se/quote/se_quote/{se_quote}",
 *     "add-form" = "/admin/se/quote/se_quote/add",
 *     "edit-form" = "/admin/se/quote/se_quote/{se_quote}/edit",
 *     "delete-form" = "/admin/se/quote/se_quote/{se_quote}/delete",
 *     "version-history" = "/admin/se/quote/se_quote/{se_quote}/revisions",
 *     "revision" = "/admin/se/quote/se_quote/{se_quote}/revisions/{se_quote_revision}/view",
 *     "revision_revert" = "/admin/se/quote/se_quote/{se_quote}/revisions/{se_quote_revision}/revert",
 *     "revision_delete" = "/admin/se/quote/se_quote/{se_quote}/revisions/{se_quote_revision}/delete",
 *     "translation_revert" = "/admin/se/quote/se_quote/{se_quote}/revisions/{se_quote_revision}/revert/{langcode}",
 *     "collection" = "/admin/se/quote/se_quote",
 *   },
