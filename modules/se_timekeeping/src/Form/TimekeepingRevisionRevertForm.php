...
/**
 * Provides a form for reverting a Timekeeping revision.
 *
 * @ingroup se_timekeeping
 */
class TimekeepingRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'se_timekeeping_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Timekeeping: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    $this->messenger()
      ->addMessage(t('Timekeeping %title has been reverted to the revision from %revision-date.', [
        '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\se_timekeeping\Entity\TimekeepingInterface $revision
