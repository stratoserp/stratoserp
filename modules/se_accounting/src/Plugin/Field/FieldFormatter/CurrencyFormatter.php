...
use Drupal\se_accounting\Service\CurrencyFormatInterface;
...
class CurrencyFormatter extends FormatterBase {
  ...
  /** @var \Drupal\se_accounting\Service\CurrencyFormatInterface */
  protected CurrencyFormatInterface $currencyFormat;

  /**
   * {@inheritdoc}
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, CurrencyFormatInterface $currencyFormat) {
