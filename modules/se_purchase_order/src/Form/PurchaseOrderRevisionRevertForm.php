...
/**
 * Provides a form for reverting a PurchaseOrder revision.
 *
 * @ingroup se_purchase_order
 */
class PurchaseOrderRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'se_purchase_order_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('PurchaseOrder: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    $this->messenger()
      ->addMessage(t('PurchaseOrder %title has been reverted to the revision from %revision-date.', [
        '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\se_purchase_order\Entity\PurchaseOrderInterface $revision
