 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/se/invoice/se_invoice/{se_invoice}",
 *     "add-form" = "/admin/se/invoice/se_invoice/add",
 *     "edit-form" = "/admin/se/invoice/se_invoice/{se_invoice}/edit",
 *     "delete-form" = "/admin/se/invoice/se_invoice/{se_invoice}/delete",
 *     "version-history" = "/admin/se/invoice/se_invoice/{se_invoice}/revisions",
 *     "revision" = "/admin/se/invoice/se_invoice/{se_invoice}/revisions/{se_invoice_revision}/view",
 *     "revision_revert" = "/admin/se/invoice/se_invoice/{se_invoice}/revisions/{se_invoice_revision}/revert",
 *     "revision_delete" = "/admin/se/invoice/se_invoice/{se_invoice}/revisions/{se_invoice_revision}/delete",
 *     "translation_revert" = "/admin/se/invoice/se_invoice/{se_invoice}/revisions/{se_invoice_revision}/revert/{langcode}",
 *     "collection" = "/admin/se/invoice/se_invoice",
 *   },
