 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}",
 *     "add-form" = "/admin/se/goods_receipt/se_goods_receipt/add",
 *     "edit-form" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/edit",
 *     "delete-form" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/delete",
 *     "version-history" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/revisions",
 *     "revision" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/revisions/{se_goods_receipt_revision}/view",
 *     "revision_revert" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/revisions/{se_goods_receipt_revision}/revert",
 *     "revision_delete" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/revisions/{se_goods_receipt_revision}/delete",
 *     "translation_revert" = "/admin/se/goods_receipt/se_goods_receipt/{se_goods_receipt}/revisions/{se_goods_receipt_revision}/revert/{langcode}",
 *     "collection" = "/admin/se/goods_receipt/se_goods_receipt",
 *   },
