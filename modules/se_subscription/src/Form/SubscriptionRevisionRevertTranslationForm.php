...
/**
 * Provides a form for reverting a Subscription revision for a single trans.
 *
...
class SubscriptionRevisionRevertTranslationForm extends SubscriptionRevisionRevertForm {
  ...
  public function getFormId() {
    return 'se_subscription_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $se_subscription_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $se_subscription_revision);
